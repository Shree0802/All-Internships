...
[![FastAPI](https://img.shields.io/badge/FastAPI-1.25+-FF4B4B?style=for-the-badge&logo=fastapi&logoColor=white)](https://fastapi.io/)
...
An end-to-end production-grade Machine Learning system and interactive FastAPI web application that analyzes multi-year historical weather datasets and predicts daily temperature trends with high precision.
...
This project was built from scratch following modern ML engineering best practices. It implements a complete data pipeline (cleaning, imputation, IQR outlier treatment, feature engineering), an automated model training & evaluation benchmark comparing 5 regression algorithms, and an interactive glassmorphic web dashboard built with FastAPI.
...
- **Interactive Web App**: 6-page FastAPI dashboard featuring:
...
### 3. Launch FastAPI Web Dashboard:
```bash
```
