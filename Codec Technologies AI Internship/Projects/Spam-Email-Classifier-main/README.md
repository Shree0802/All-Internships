...
[![Live Demo](https://img.shields.io/badge/Live_Demo-Streamlit_App-FF4B4B?style=for-the-badge&logo=streamlit&logoColor=white)](https://spam-email-classifier-26r5kcjbnn9ecqv4tmbh5w.streamlit.app/)
[![Framework](https://img.shields.io/badge/Streamlit-1.28+-FF4B4B?style=for-the-badge&logo=streamlit&logoColor=white)](https://streamlit.io/)
...
🚀 **Deployed Streamlit Application**: [https://spam-email-classifier-26r5kcjbnn9ecqv4tmbh5w.streamlit.app/](https://spam-email-classifier-26r5kcjbnn9ecqv4tmbh5w.streamlit.app/)
...
- **Interactive Web UI**: Responsive multi-page Streamlit application with custom dark glassmorphism aesthetic.
...
### 🏷️ GitHub Topics
`machine-learning` `spam-classifier` `nlp` `python` `streamlit` `naive-bayes` `email-classification` `scikit-learn` `artificial-intelligence` `text-classification` `student-project`
